...
To update the website URL after deployment:

1. Edit `index.html` - update redirect URLs (lines 13, 186)
2. Edit `manifest.json` - update `start_url` and `scope` (lines 5-6)
